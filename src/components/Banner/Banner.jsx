      ...
      <div className="container mx-auto">
        <div style={{backgroundColor:data.bgColor}} className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl">
          ...
          <div data-aos="zoom-in" className="h-full flex items-center">
            <img src={data.image} alt={data.title} className="scale-125 w-[250px] md:w-[340px] mx-auto drop-shadow-2xl object-cover"/>
          </div>
          {/* third col */}
          <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
            ...
            <p data-aos="fade-up" className="text-sm tacking-wide leading-5">{ data.title4}</p>
            <div>
                <button data-aos="fade-up" data-aos-offset="0" className="bg-white text-gray-700 font-semibold px-4 py-1 rounded-4xl">Shop Now</button>
            </div>
          </div>
        </div>
      </div>
